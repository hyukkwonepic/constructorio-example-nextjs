...
export default function Home() {
  return (
    <div className="mx-auto text-center max-w-[2000px] pt-4">
      <h1 className="my-4 text-2xl font-bold">Constructor.io Next.js Example</h1>
      <p>
      ...
      <div className="flex justify-around mt-10">
        <div className="flex flex-col rounded-lg justify-between border border-2 border-gray-300 p-4 w-[30%]">
          ...
          <Link href="/client-side" className="block mt-4 rounded-lg px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white font-semibold tracking-wide">
            Example
          </Link>
        </div>
        <div className="flex flex-col rounded-lg justify-between border border-2 border-gray-300 p-4 w-[30%]">
          ...
          <Link href="/server-side" className="block mt-4 rounded-lg px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white font-semibold tracking-wide">
            Example
          </Link>
        </div>
        <div className="flex flex-col rounded-lg justify-between border border-2 border-gray-300 rounded-lg p-4 w-[30%]">
          ...
          <Link href="/client-and-server-side" className="block mt-4 rounded-lg px-4 py-3 bg-blue-400 hover:bg-blue-600 text-white font-semibold tracking-wide">
            Example
          </Link>
        </div>
      </div>
